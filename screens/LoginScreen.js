  ...
  const signInWithGoogleAsync = async () => {
    try {
      const result = await Google.logInAsync({
        androidClientId: '637775984367-1v8amrhp0ricm6ocfjbds52vbki08gpb.apps.googleusercontent.com',
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.image}>
        ...
        <Text style={{ padding: 20, color: '#858282', fontSize: 16 }}>Bắt đầu từ 14/12/2020, tài khoản đăng nhập của sinh viên có cú pháp họ đêm viết tắt + tên + lớp sinh hoạt @vku.udn.vn.</Text>
      </View>
